    ...
    return (
        <div className='bg-white rounded-md p-6 h-[95vh] overflow-y-scroll'>
            <div className='flex items-start justify-center gap-8'>
                <img src="https://www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/img/figure/student1.jpg" alt="" />
                <div className=''>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>Name :</td>
                                <td className='font-bold pl-6 pb-4'>Kaiser Tanveer</td>
                            </tr>
                            <tr>
                                <td>Gander :</td>
                            ...
                            <tr>
                                <td>User Type :</td>
                                <td className='font-bold pl-6 pb-4'>Super Admin</td>
                            </tr>
                            <tr>
                                <td>Father :</td>
