        ...
        <div className='rounded-md h-full group'>
            <div ref={cardRef} className={`card-inner rounded-md ${flipped ? 'rotateY-180' : ''}`}>
                ...
                <div className='card-front'>
                    ...
                    <div className={user?.UserType === "Student" ? 'card bg-blue-700 h-[160px] mb-[90px] rounded-t-md' : 'card bg-gray-500 h-[160px] mb-[90px] rounded-t-md'}>
                    ...
                    <div className='w-[74%] mx-auto pt-4 pb-2 text-justify'>
                        ...
                        <div className={user?.UserType === "Student" ? 'font-semibold text-blue-700 flex items-start' : "flex items-start font-semibold text-gray-700"}>
                    ...
                    <div className={user?.UserType === "Student" ? 'bg-blue-700 h-6 rounded-b-md' : 'bg-gray-500 h-6 rounded-b-md border-b-[12px] border-gray-700'}></div>
                </div>
                ...
                <div className={`card-back bg-white rounded-md w-full h-full shadow-md ${flipped ? '' : 'rotateY-180'}`}>
                    <button onClick={handleFlip} className='absolute top-2 right-2 bg-white rounded'>
                        <MdFlipCameraAndroid className='text-2xl font-extrabold text-blue-700 bg-white hover:animate-spin duration-500 rounded-full'/>
                    </button>
                    <div className='p-6 w-full h-[466px]'>
                        <h4 className='text-xl text-blue-700 font-bold py-6'>Hera Islamic Academy</h4>
                    ...
                    <div className='h-6 rounded-b-md bg-gradient-to-r from-blue-700 via-gray-500 to-black'></div>
                </div>
            </div>
        </div>
    );
