...
const UserCount = () => {
    ...
    return (
        <div className='flex items-center justify-between gap-6'>
            <div className='bg-white rounded-md border border-sky-200 shadow-md h-24 w-full flex items-center justify-between p-4'>
                <FaUsers className='text-6xl p-2 text-blue-700 bg-sky-100 rounded-full'/>
                <p className='text-xl font-semibold'>
                    <span className='text-gray-600'>Students</span><br />
                    <span>{students.length}</span> {/* Display actual count of Students */}
                </p>
            </div>
            <div className='bg-white rounded-md border border-green-200 shadow-md h-24 w-full flex items-center justify-between p-4'>
                <FaUsers className='text-6xl p-2 text-green-500 bg-green-100 rounded-full'/>
                <p className='text-xl font-semibold'>
                    <span className='text-gray-600'>Teachers</span><br />
                    <span>{teachers.length}</span> {/* Display actual count of Teachers */}
                </p>
            </div>
            <div className='bg-white rounded-md border border-yellow-200 shadow-md h-24 w-full flex items-center justify-between p-4'>
                <FaUsers className='text-6xl p-2 text-blue-700 bg-sky-100 rounded-full'/>
                <p className='text-xl font-semibold'>
                    <span className='text-gray-600'>Parents</span><br />
                    <span>{parents.length}</span> {/* Display actual count Parents */}
                </p>
            </div>
            <div className='bg-white rounded-md border border-red-200 shadow-md h-24 w-full flex items-center justify-between p-4'>
